...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 2v2M9 2v2M9 18v2m6-2v2" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 10H3m2 4H3m16-4h-2m2-4h-2" />
    </svg>
);
